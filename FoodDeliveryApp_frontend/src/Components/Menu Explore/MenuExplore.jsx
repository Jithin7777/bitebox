        ...
        <div className='explore-menu' id='explore-menu'>
            <div className=' mt-5 ms-5 me-5'>
                <h1>Explore Our Menu</h1>
                        ...
                        <h6 className='explore-menu-text' >Choose from a diverse menu featuring a delectable array of dishes .Our mission is to satisfy your cravings and elevate your dining experience,onedelicious meal at a time</h6>
